...
export async function POST(request) {
  ...
  return NextResponse.json({ envKey: key, result: { ok: result.ok, usedMock: result.usedMock, error: result.error ?? null, model: result.model ?? null, hasData: Boolean(result.dataUrl) } });
}